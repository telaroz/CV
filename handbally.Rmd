...
* Development of a package with functions to draw a court, goal, pace 
plots from handball Play by Play data. Also, contains functions to scrape and 
transform data from PDF files containing Play by Play data.
The package is available in the 
[`handbaloner` repository](https://github.com/telaroz/handbaloner).
...
* Courses imparted mainly by Xavier Pascual, FC Barcelona trainer at the time, 
and Anselmo Ruíz Alarcón, sports data analyst. 

**Other developments**

* Extraction, structuring and data opening of the play by play of the 2021 and 2023
World Men's Handball Championship. Data and the code to generate it is freely 
available: [2021](https://github.com/telaroz/egipto21) and 
[2023](https://github.com/telaroz/pol_swe_2023_data).
...
* Simplifying and automation of workflows for API consumption.
* Deployment of basic workflows to cloud (Google Cloud Computing)
* Imparted intermediate and advanced R courses for financial institutions
* All this work done through a clean version control workflow and focusing on 
complete documentation. 

**Mastercard SJO Center of Excellence**  
Associate Consultant, Advanced Analytics.  
San José, Costa Rica. May 2019 -- May 2022
...
behavioral segmentations, campaign performance diagnostics, product migration 
...
* Imparted multipe R trainings for the team (best practices, optimization,
`data.table`, `purrr`).
...
## Technical Skills
  ...
  - Experience in R development: package creation, parallelization and highly efficient code. 
